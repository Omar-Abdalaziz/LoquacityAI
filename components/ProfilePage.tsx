...
export const ProfilePage: React.FC<SettingsModalProps> = ({ isOpen, onClose, session }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50 animate-fade-in p-4" aria-modal="true" role="dialog" onClick={onClose}>
        <div className="relative bg-neutral-50 dark:bg-neutral-900 rounded-2xl shadow-xl w-full max-w-5xl h-full max-h-[90vh] flex flex-col animate-pop-in" onClick={e => e.stopPropagation()}>

...
import { 
    UserCircleIcon, LogoIcon, ClipboardIcon, ShareIcon, ArrowPathIcon, CheckIcon, 
...
}> = ({ msg, userPrompt, onCopy, onRewrite, onExport, copiedMessageId, onCitationClick, highlightedSource, isFirstQuery }) => {
    ...
    return (
        <div className="animate-pop-in border-t border-neutral-200 dark:border-neutral-800 pt-6">
            ...
            <div ref={contentRef}>
                ...
                {activeTab === 'Steps' && (
                    <StepsView query={userPrompt} sources={msg.sources || []} />
                )}
            </div>
            ...
            <div className="mt-6 pt-4 border-t border-neutral-200 dark:border-neutral-800 flex items-center justify-between flex-wrap gap-x-4 gap-y-2">
                <div className="flex items-center gap-1 sm:gap-2">
                    <button className="flex items-center gap-1.5 text-sm font-medium text-neutral-600 dark:text-neutral-300 hover:bg-neutral-100 dark:hover:bg-neutral-800/80 px-2.5 py-1.5 rounded-md transition-colors"><ShareIcon className="w-4 h-4" /> Share</button>
                ...
                <div className="flex items-center gap-1">
                    ...
                    <button title="Good response" className="p-2 rounded-lg hover:bg-neutral-100 dark:hover:bg-neutral-800/80 text-neutral-500 dark:text-neutral-400 transition-colors">
                        <ThumbsUpIcon className="w-5 h-5" />
                    </button>
                    <button title="Bad response" className="p-2 rounded-lg hover:bg-neutral-100 dark:hover:bg-neutral-800/80 text-neutral-500 dark:text-neutral-400 transition-colors">
